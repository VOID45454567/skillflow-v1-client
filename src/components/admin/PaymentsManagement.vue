        ...
        <table class="w-full">
          <thead class="bg-white/30 border-b border-gray-200/40">
            <tr>
              ...
              <th class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase">Метод</th>
            ...
            >
              ...
              <td class="px-6 py-4">
                <div class="flex items-center gap-2">
                  ...
                  />
                  <div>
                    <span class="text-sm text-gray-700">{{ payment.user?.login || '—' }}</span>
...
import { Search, CreditCard, Wallet, TrendingUp, ChevronLeft, ChevronRight } from '@lucide/vue'
